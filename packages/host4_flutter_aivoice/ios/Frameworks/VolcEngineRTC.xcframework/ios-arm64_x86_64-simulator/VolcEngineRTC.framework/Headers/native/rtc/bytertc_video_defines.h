...
struct MediaStreamInfo {
     ...
     * 
     * @brief 视频流的属性。 <br>
     *        当远端用户调用 setVideoEncoderConfig{@link #IRTCEngine#setVideoEncoderConfig} 方法发布多个配置的视频流时，此处会包含该用户发布的所有视频流的属性信息。 <br>
...
public:
     ...
     * @param video_source 本地视频源类型，参看 IVideoSource{@link #IVideoSource}
